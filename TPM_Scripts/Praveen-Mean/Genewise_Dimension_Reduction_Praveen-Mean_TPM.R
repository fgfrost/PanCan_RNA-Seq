...
sftDF <- 
  fread("/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Praveen-Mean/sftPower_Praveen-Mean.csv",
        sep = ",",
        header = TRUE,
        data.table = FALSE
        )
...
par(mfrow = c(1,1))
png("All_Gene_Dendrogram_With_Colors_Test_Set_Praveen-Mean.png",
    height = 800,
    width = 800
    )
...
png("Module_Gene_Dendrogram_With_Colors_Test_Set_UPraveen-Mean.png",
    height = 800,
    width = 800
    )
...
png("Test_Set_TOMplot_Praveen-Mean.png",
    height = 800,
    width = 800
    )
...
groups %>%
  ...
  fwrite("/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Praveen-Mean/HC_Group_Assignments_Uncorrected.csv",
         sep = ",",
         row.names = FALSE,
         col.names = TRUE
         )

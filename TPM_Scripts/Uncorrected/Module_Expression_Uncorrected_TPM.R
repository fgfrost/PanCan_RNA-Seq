...
ModuleExpression <- log10(ModuleExpression)
...
ModuleExpression[,rownames(primarySiteColsDendro)] %>%
  pheatmap(col = HeatPal,
           ...
           filename = "Cluster-Wise_Expression_of_Modules_Uncorrected.png",
           height = 11,
           width = 12
           )
...
ModuleExpression[,rownames(primarySiteColsRaw)] %>%
  pheatmap(col = HeatPal,
           ...
           filename = "Tissue-Wise_Expression_of_Modules_Uncorrected.png",
           height = 11,
           width = 12
           )

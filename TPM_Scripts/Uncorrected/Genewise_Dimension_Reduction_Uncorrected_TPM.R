...
sftDF <- 
  fread("/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Uncorrected/sftPower_GrandMean.csv",
        sep = ",",
        header = TRUE,
        data.table = FALSE
        )
...
setwd("/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Uncorrected")
...
par(mfrow = c(1,1))
png("All_Gene_Dendrogram_With_Colors_Test_Set_Uncorrected.png",
    height = 800,
    width = 800
    )
...
png("Module_Gene_Dendrogram_With_Colors_Test_Set_Uncorrected.png",
    height = 800,
    width = 800
    )
...
png("Test_Set_TOMplot_Uncorrected.png",
    height = 800,
    width = 800
    )
...
groups %>%
  ...
  fwrite("/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Uncorrected/HC_Group_Assignments_Uncorrected.csv",
         sep = ",",
         row.names = FALSE,
         col.names = TRUE
         )

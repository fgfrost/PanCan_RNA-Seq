...
ModuleFolder <- "/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Uncorrected/Module_Genes/"
Module_Enrichment <-
...
for (i in 1:length(Module_Enrichment)) {
  ...
  TempFile <- Temp[1]
  TempFile <- 
    gsub("/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Uncorrected/Module_Genes/",
         "",
         TempFile
         )
  Temp <- Temp[-1]
...
fwrite(Module_Enrichment.df,
       "/Users/a703402454/Desktop/UCSC_Project_Testing/Test_Data_Set_70%/TPM_Analysis/WGCNA_Plots_Uncorrected/Module_Enrichment_Uncorrected.csv",
       sep = ",",
       col.names = TRUE,
       row.names = FALSE
       )
